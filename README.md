...
В версии 1.3 обновлены оформление и доступность. Подробнее: [принципы дизайна и проверка](docs/DESIGN.md).
...
1. Скачайте `Target-Mac-DFU-1.3.0.zip` из раздела **Releases**.
